...
mod test_events {
    ...
    fn test_create_policy_emits_event_exists() {
        ...
        let coverage_type1 = CoverageType::Health;
        ...
        let coverage_type2 = CoverageType::Emergency;
        ...
        let coverage_type3 = CoverageType::Life;
    ...
    fn test_multiple_policies_management() {
        ...
        let mut policy_ids: Vec<u32> = Vec::new(&env);
        let policy_names = [
            String::from_str(&env, "Policy A"),
            String::from_str(&env, "Policy B"),
            String::from_str(&env, "Policy C"),
        ];
